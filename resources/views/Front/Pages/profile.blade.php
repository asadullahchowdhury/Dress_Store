        ...
        <div class="row p-2">
            ...
            <div class="col-md-9 fw-bold">
                <div class="col p-2 border bg-light">
                    <div class="h4 fw-bold text-dark p-2 border-danger border-bottom">Dashboard</div>
                    ...
                    <div class="row row-cols-md-2 row-cols-1 p-2">
                        <div class="col p-2">
                            <div class="col p-2 border rounded bg-white">
                                <span class="text-danger">Full Name:</span> <br> Mahi Bashar Akash
                            </div>
                        </div>
                        <div class="col p-2">
                            <div class="col p-2 border rounded bg-white">
                                <span class="text-danger">Email Address:</span> <br> mahibashar@gmail.com
                            </div>
                        </div>
                        <div class="col p-2">
                            <div class="col p-2 border rounded bg-white">
                                <span class="text-danger">Phone Number:</span> <br> 01645820007
                            </div>
                        </div>
                        <div class="col p-2">
                            <div class="col p-2 border rounded bg-white">
                                <span class="text-danger">Present Address:</span> <br> Dhanmondi, Dhaka - 1209, Bangladesh
                            </div>
                        </div>
                    </div>
                </div>
