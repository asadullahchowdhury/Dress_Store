        ...
        <div class="row px-2">
            <div class="col-md-4">
                <div class="col bg-light p-2">
                    <div class="fw-bold text-dark pb-2 border-bottom border-danger">
                    ...
                    <form action="" method="post" class="fw-bold p-2">
                        ...
                        <div class="mb-3">
                            <label class="form-label text-danger">Present Address:</label>
                            <input type="text" name="" class="form-control form-control-sm" required>
                        </div>
                        <hr>
            ...
            <div class="col-md-8">
                <div class="col bg-light p-2">
                    ...
                    <div class="row px-2 fw-bold text-danger">
                        <div class="col-4">
                            <div class="row">
                    ...
                    <div class="col p-1">
                        <div class="row px-1 fw-bold text-danger">
                    ...
                    <a href="" class="form-control form-control-sm btn btn-sm btn-danger">
                        Order Confirm
                    </a>
                </div>
            </div>
